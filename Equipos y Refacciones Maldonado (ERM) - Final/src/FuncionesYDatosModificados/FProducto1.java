...
public class FProducto1 {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        sSQL = "SELECT Cod_Producto,Nombre_Producto,Descripcion,Replace(Format(Precio_Venta, 0), ',', '.') As Precio_Venta , Replace(Format(Precio_Compra, 0), ',', '.') AS Precio_Compra ,Existencia,(SELECT Nombre_Almacen FROM Almacen WHERE Cod_Almacen = Cod_AlmacenFK) AS Nombre_Almacen FROM Producto WHERE Descripcion LIKE '%" + buscar + "%' ORDER BY Cod_Producto DESC";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                registros[6] = rs.getString("Nombre_Almacen");
    ...
    public boolean insertar(DProducto1 datos,String nombre) {
    ...
    public boolean editar(DProducto1 datos, String nombre) {
    ...
    public boolean eliminar(DProducto1 datos) {
     ...
     * ***** FUNCION STOCK ****
     */
    public boolean ModificarStockProductos(DProducto1 datos) {
