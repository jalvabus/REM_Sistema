...
import static Frames.FrmPrincipal.MenuProductos;
...
public final class FrmProductos extends javax.swing.JInternalFrame {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        String precioProducto2 = Precio_Venta.replaceAll("\\.", "");
        datos.setPrecio_Venta(Long.parseLong(precioProducto2));
        
        String Precio_Compra = txtPrecio_Compra.getText();
        String precioCompraProd2 = Precio_Compra.replaceAll("\\.", "");
        datos.setPrecio_Compra(Long.parseLong(precioCompraProd2));
