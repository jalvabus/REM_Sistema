...
public class FrmMostrarVentas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnPrint.setForeground(new java.awt.Color(25, 118, 210));
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        datos.setNo_Factura(Integer.parseInt(txtNum_factura.getText()));
        if (funcion.editar(datos)) {
            JOptionPane.showMessageDialog(null, "La venta fue editada exitosamente.");
            mostrar();
            limpiar();
        } else {
