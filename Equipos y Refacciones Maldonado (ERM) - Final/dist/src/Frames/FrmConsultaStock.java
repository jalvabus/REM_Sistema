...
import static Frames.FrmPrincipal.lblId_Usuario;
...
public class FrmConsultaStock extends javax.swing.JInternalFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmConsultaStock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmConsultaStock().setVisible(true);
            }
        });
    }
