...
import Frames.FrmAlmacen;
import Frames.FrmCliente;
import Frames.FrmMostrarVentas;
import Frames.FrmProductos;
import Frames.FrmStock;
import Frames.FrmUsuario;
import Frames.FrmVentaDetalle;
//import Controlador.rptTotalRecaudacion;
import Frames.rptVentasFechas;
import Frames.rptVentasPorAlmacen;
import static Frames.rptVentasFechas.comprobar;
...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void JmIVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JmIVentasActionPerformed
        ...
        form.setClosable(true);
        form.setIconifiable(true);
        FrmVentaDetalle.txtCod_usuario.setText(lblId_Usuario.getText());
        FrmVentaDetalle.txtNombre_usuario.setText(lblNombre.getText());
        try {
            form.setMaximum(true);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "ERROR ");
